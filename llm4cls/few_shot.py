...
def inference(dataset,sample_dataset,model,tokenizer,task_description,label2text,device,k,sample_method="random",max_new_tokens=20,temperature=0.1,do_sample=False,tailor_size=None,majority_vote=False):
    """
    Zero-shot inference
